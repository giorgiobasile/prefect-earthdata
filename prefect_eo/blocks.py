...
class EoBlock(Block):
    ...
    Example:
        Load a stored value:
        ```python
        from prefect_eo import EoBlock
        block = EoBlock.load("BLOCK_NAME")
        ```
    """
    ...
    _documentation_url = "https://giorgiobasile.github.io/prefect-eo/blocks/#prefect-eo.blocks.EoBlock"  # noqa
